...
> 最后更新：2026-06-26 | 收录：6 项

| 名称 | 仓库 | Stars | 安全 | 安装方式 | 简介 | 首次收录 |
|------|------|-------|------|----------|------|----------|
| ECC | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 221,747 | ✅ | npm install -g ecc | 67 agents + 271 skills 的 agent 操作系统，内置 AgentShield 安全扫描 | 2026-06-26 |
| Open Design | [nexu-io/open-design](https://github.com/nexu-io/open-design) | 71,173 | ✅ | 桌面版 / Docker | 本地优先 Claude Design 替代品，100+ skills + 150 设计系统 | 2026-06-26 |
| Claude HUD | [jarrodwatts/claude-hud](https://github.com/jarrodwatts/claude-hud) | 25,716 | ✅ | /plugin install | 实时显示上下文用量、工具状态和 agent 进度 | 2026-06-25 |
